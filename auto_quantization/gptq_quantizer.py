        ...
        # Save quantized model
            ...
            def benchmark_latency(self, model_path):
                ...
                if __name__ == "__main__":
                    ...
                    quantizer.quantize_model(bits=4) # Experiment with different bit sizes (e.g., 2, 3, 4, 8)
                    quantizer.export_to_onnx("./quantized_model")
                    quantizer.benchmark_onnx_latency("./onnx_model")
